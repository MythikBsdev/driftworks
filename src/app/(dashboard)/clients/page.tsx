...
const ClientsPage = async () => {
  ...
  const totalOutstanding = clients.reduce((acc, client) => acc + client.outstandingTotal, 0);
      ...
      <div className="grid gap-8 lg:grid-cols-[2fr_1fr]">
        ...
        <div className="rounded-3xl border border-white/10 bg-[#0f0f0f]/85 p-6">
          ...
          <p className="mt-1 text-sm text-white/60">
            Clients sync directly to Supabase and become available in invoice forms instantly.
          </p>
          <div className="mt-6">
            <NewClientForm />
          </div>
